...
:installdeps
	...
	call :download amneziawg-tools.zip https://github.com/amnezia-vpn/amneziawg-tools/archive/v3.0.20260730.zip 3f4f342a03668a8822c38d9b17aeda8528525b0f1af2678ecb39b144b3d74da7 "--exclude wg-quick --strip-components 1" || goto :error
