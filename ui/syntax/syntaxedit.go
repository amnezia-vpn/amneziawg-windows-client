...
var stylemap = map[highlight]spanStyle{
	...
	highlightHeaderProtectionKey:    {color: win.RGB(0x64, 0x38, 0x20)},
	highlightContentPaddingAddition: {color: win.RGB(0x64, 0x38, 0x20)},
	highlightRekeyAfterTime:         {color: win.RGB(0x1C, 0x00, 0xCF)},
	highlightRekeyTimeout:           {color: win.RGB(0x1C, 0x00, 0xCF)},
